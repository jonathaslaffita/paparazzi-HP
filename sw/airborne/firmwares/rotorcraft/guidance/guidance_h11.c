...
#define GUIDANCE_FORWARD_THRUST MAX_PPRZ/2
#endif
...
static void guidance_h_traj_run(bool in_flight)
{
  ...
  // PRINT("GUIDANCE_FORWARD_THRUST: %d  GUIDANCE_SIDE_THRUST: %d GUIDANCE_SIDE_THRUST: %d \n", guidance_h_cmd_earth.y, guidance_h_sideact.y, guidance_h_sideact.z);
